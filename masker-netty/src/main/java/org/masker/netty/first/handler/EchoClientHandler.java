...
public class EchoClientHandler extends SimpleChannelInboundHandler<ByteBuf> {
    ...
    public void channelActive(ChannelHandlerContext ctx) throws Exception {
        ...
        ctx.writeAndFlush(Unpooled.copiedBuffer("hello netty you are welcome2!".getBytes(StandardCharsets.UTF_8)));
        Thread.sleep(1000L);
        ctx.writeAndFlush(Unpooled.copiedBuffer("hello netty you are welcome3!".getBytes(StandardCharsets.UTF_8)));
    }
